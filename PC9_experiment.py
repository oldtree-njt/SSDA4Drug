...
def main(args):
    ...
    ####################################################################################################################
    # Loading Source Data
    x_source = pd.read_csv("./experiment/PC9/source_data" + "/source_scaled" + args.gene + ".csv",
                           index_col=0)
    # train
    x_train_source = pd.read_csv("./experiment/PC9/source_data" + '/' + gene + "/X_train_source.csv",
                                 index_col=0)
    y_train_source = pd.read_csv("./experiment/PC9/source_data" + '/' + gene + "/Y_train_source.csv",
                                 index_col=0)

    if args.sampling_method == "weight":
        y_source = pd.read_csv("./experiment/PC9/source_data/source_meta_data.csv", index_col=0)
    ...
    # valid
    x_val_source = pd.read_csv("./experiment/PC9/source_data" + '/' + gene + "/X_val_source.csv",
                               index_col=0)
    y_val_source = pd.read_csv("./experiment/PC9/source_data" + '/' + gene + "/Y_val_source.csv",
                               index_col=0)
    ...
    x_train_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/X_train_target.csv",
        index_col=0)
    y_train_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/Y_train_target.csv",
        index_col=0)
    ...
    x_val_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/X_val_target.csv",
        index_col=0)
    y_val_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/Y_val_target.csv",
        index_col=0)
    ...
    # train
    x_train_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/X_train_target.csv",
        index_col=0)
    y_train_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/Y_train_target.csv",
        index_col=0)
    target_train = utils.create_dataset(x=x_train_target, y=y_train_target, batch_size=batch_size, shuffle=True)

    # valid
    x_val_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/X_val_target.csv",
        index_col=0)
    y_val_target = pd.read_csv(
        "./experiment/PC9" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/Y_val_target.csv",
        index_col=0)
    target_valid = utils.create_dataset(x=x_val_target, y=y_val_target, batch_size=batch_size, shuffle=False)
    ...
    # test
    X = pd.read_csv("./experiment/PC9/target_data/target_test_X.csv", index_col=0)
    Y = pd.read_csv("./experiment/PC9/target_data/target_test_Y.csv", index_col=0)
    test_data = utils.create_dataset(x=X, y=Y, batch_size=batch_size, shuffle=False)

    ####################################################################################################################
    # data loading finished
    ####################################################################################################################
    bulk_tasks = {'expression': 2245, 'pathway': 128}
    sc_tasks = {'expression': 2245, 'pathway': 128}
    dim_model_out = 2
    ...
    test_predicted_t48_file = "./experiment/PC9/PC9.tsv"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--drug', type=str, default='Erlotinib',
    ...
    # save
    parser.add_argument('--result', type=str, default='experiment/PC9/',
                        help='Path of the training result report files')
    parser.add_argument('--sc_all', type=str, default='experiment/PC9/',
