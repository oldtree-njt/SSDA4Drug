...
def main(args):
    ...
    ####################################################################################################################
    # Loading Source Data
    x_source = pd.read_csv("./experiment/OSCC/source_data" + "/source_scaled" + args.gene + ".csv",
                           index_col=0)
    # train
    x_train_source = pd.read_csv("./experiment/OSCC/source_data" + '/' + gene + "/X_train_source.csv",
                                 index_col=0)
    y_train_source = pd.read_csv("./experiment/OSCC/source_data" + '/' + gene + "/Y_train_source.csv",
                                 index_col=0)

    if args.sampling_method == "weight":
        y_source = pd.read_csv("./experiment/OSCC/source_data/source_meta_data.csv", index_col=0)
    ...
    # valid
    x_val_source = pd.read_csv("./experiment/OSCC/source_data" + '/' + gene + "/X_val_source.csv",
                               index_col=0)
    y_val_source = pd.read_csv("./experiment/OSCC/source_data" + '/' + gene + "/Y_val_source.csv",
                               index_col=0)
    ...
    x_train_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/X_train_target.csv",
        index_col=0)
    y_train_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/Y_train_target.csv",
        index_col=0)
    ...
    x_val_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/X_val_target.csv",
        index_col=0)
    y_val_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/Y_val_target.csv",
        index_col=0)
    ...
    # train
    x_train_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/X_train_target.csv",
        index_col=0)
    y_train_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/Y_train_target.csv",
        index_col=0)
    target_train = utils.create_dataset(x=x_train_target, y=y_train_target, batch_size=batch_size, shuffle=True)

    # valid
    x_val_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/X_val_target.csv",
        index_col=0)
    y_val_target = pd.read_csv(
        "./experiment/OSCC" + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/Y_val_target.csv",
        index_col=0)
    target_valid = utils.create_dataset(x=x_val_target, y=y_val_target, batch_size=batch_size, shuffle=False)
    ...
    # test
    X = pd.read_csv("./experiment/OSCC/target_data/target_scaled.csv", index_col=0)
    Y = pd.read_csv("./experiment/OSCC/target_data/target_meta_data.csv", index_col=0)
    ...
    ####################################################################################################################
    bulk_tasks = {'expression': 14543, 'pathway': 128}
    sc_tasks = {'expression': 14543, 'pathway': 128}
    dim_model_out = 2
    ...
    test_predicted_t48_file = "./experiment/OSCC/OSCC.tsv"
...
if __name__ == '__main__':
    ...
    # save
    parser.add_argument('--result', type=str, default='experiment/OSCC/',
                        help='Path of the training result report files')
    parser.add_argument('--sc_all', type=str, default='experiment/OSCC/',
    ...
    parser.add_argument('--epochs', type=int, default=100, help='Number of epoches training. Default: 500')
    parser.add_argument('--batch_size', type=int, default=128, help='Number of batch size when training. Default: 200')
