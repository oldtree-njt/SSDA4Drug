...
def main(args):
    ...
    x_source = pd.read_csv("./data/SCAD" + '/' + args.drug + "/source_data/source_scaled" + args.gene + ".csv",
                           index_col=0)
    # train
    x_train_source = pd.read_csv("./data/SCAD" + '/' + args.drug + "/source_data" + '/' + gene + "/X_train_source.csv",
                                 index_col=0)
    y_train_source = pd.read_csv("./data/SCAD" + '/' + args.drug + "/source_data" + '/' + gene + "/Y_train_source.csv",
                                 index_col=0)
    ...
    # valid
    x_val_source = pd.read_csv("./data/SCAD" + '/' + args.drug + "/source_data" + '/' + gene + "/X_val_source.csv",
                               index_col=0)
    y_val_source = pd.read_csv("./data/SCAD" + '/' + args.drug + "/source_data" + '/' + gene + "/Y_val_source.csv",
                               index_col=0)
    ...
    x_train_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/X_train_target.csv",
        index_col=0)
    y_train_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/Y_train_target.csv",
        index_col=0)
    ...
    x_val_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/X_val_target.csv",
        index_col=0)
    y_val_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/unlabeled_target_data" + '/' + "/Y_val_target.csv",
        index_col=0)
    ...
    # train
    x_train_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/X_train_target.csv",
        index_col=0)
    y_train_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/Y_train_target.csv",
        index_col=0)
    target_train = utils.create_dataset(x=x_train_target, y=y_train_target, batch_size=batch_size, shuffle=True)

    # valid
    x_val_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/X_val_target.csv",
        index_col=0)
    y_val_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/labled_target_data" + '/' + "/Y_val_target.csv",
        index_col=0)
    target_valid = utils.create_dataset(x=x_val_target, y=y_val_target, batch_size=batch_size, shuffle=False)
    ...
    # test
    x_test_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/test_data/unlabeled_test_X.csv",
        index_col=0)
    y_test_target = pd.read_csv(
        "./data/SCAD" + '/' + args.drug + '/' + args.shot_method + '/' + gene + "/test_data/unlabeled_test_Y.csv",
        index_col=0)
    ...
    trainer.test_single_model(test_model, test_dataset, loss_class, device, test_predicted_y_file, y_test_target)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--drug', type=str, default='Sorafenib',
    ...
    parser.add_argument('--epochs', type=int, default=50, help='Number of epochs training. Default: 500')
    ...
    parser.add_argument('--method', type=str, default="few-shot",
                        help='choose model type. Default: few-shot')
